...
G = 0.75 * 6.67428e-11         # The gravitational constant G
...
class planet(Turtle):   # This function defines the parameters for each planets
    ...
    vx = vy = 0.0       # Initialize velocity of the planet as 0
    xloc = yloc = 0.0   # Initialize location of the planet as 0
...
def main():                             # Sets up the positions, velocities, colours, and shapes of the planets on the display
    ...
    loop([sun, mercury, venus, earth, mars, jupiter, moon])       # Goes to the function called loop (line 37). Takes these planets and creates a solar system.
